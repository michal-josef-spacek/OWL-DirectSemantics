package OWL::DirectSemantics::Element::DataIntersectionOf;

BEGIN {
	$OWL::DirectSemantics::Element::DataIntersectionOf::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::DataIntersectionOf::VERSION   = '0.000_03';
};
...
OWL::DirectSemantics::Element::DataIntersectionOf - represents an OWL DataIntersectionOf

=head1 DESCRIPTION

This class represents the DataIntersectionOf element in OWL Direct Semantics.
