package OWL::DirectSemantics::Element::DataOneOf;

BEGIN {
	$OWL::DirectSemantics::Element::DataOneOf::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::DataOneOf::VERSION   = '0.000_03';
};
...
OWL::DirectSemantics::Element::DataOneOf - represents an OWL DataOneOf

=head1 DESCRIPTION

This class represents the DataOneOf element in OWL Direct Semantics.
