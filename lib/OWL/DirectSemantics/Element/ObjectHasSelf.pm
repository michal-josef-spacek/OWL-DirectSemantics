package OWL::DirectSemantics::Element::ObjectHasSelf;
...
sub fs_arguments { return ($_[0]->property); }
...
This class represents the ObjectHasSelf element in OWL Direct Semantics.
