package OWL::DirectSemantics::Element::ReflexiveObjectProperty;

BEGIN {
	$OWL::DirectSemantics::Element::ReflexiveObjectProperty::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::ReflexiveObjectProperty::VERSION   = '0.000_03';
};
...
OWL::DirectSemantics::Element::ReflexiveObjectProperty - represents an OWL ReflexiveObjectProperty

=head1 DESCRIPTION

This class represents the ReflexiveObjectProperty element in OWL Direct Semantics.
