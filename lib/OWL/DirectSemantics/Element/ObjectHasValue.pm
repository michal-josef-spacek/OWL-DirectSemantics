package OWL::DirectSemantics::Element::ObjectHasValue;

BEGIN {
	$OWL::DirectSemantics::Element::ObjectHasValue::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::ObjectHasValue::VERSION   = '0.000_03';
};
...
OWL::DirectSemantics::Element::ObjectHasValue - represents an OWL ObjectHasValue

=head1 DESCRIPTION

This class represents the ObjectHasValue element in OWL Direct Semantics.
