package OWL::DirectSemantics::Element::ObjectProperty;

BEGIN {
	$OWL::DirectSemantics::Element::ObjectProperty::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::ObjectProperty::VERSION   = '0.000_03';
};

use constant MAPPING_CODE => 'OPE';
...
OWL::DirectSemantics::Element::ObjectProperty - represents an OWL ObjectProperty

=head1 DESCRIPTION

This class represents the ObjectProperty element in OWL Direct Semantics.
