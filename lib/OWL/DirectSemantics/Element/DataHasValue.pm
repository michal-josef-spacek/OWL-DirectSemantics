package OWL::DirectSemantics::Element::DataHasValue;

BEGIN {
	$OWL::DirectSemantics::Element::DataHasValue::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::DataHasValue::VERSION   = '0.000_03';
};
...
sub fs_arguments { return ($_[0]->property, $_[0]->value); }
...
OWL::DirectSemantics::Element::DataHasValue - represents an OWL DataHasValue

=head1 DESCRIPTION

This class represents the DataHasValue element in OWL Direct Semantics.
