package OWL::DirectSemantics::Element::ObjectIntersectionOf;

BEGIN {
	$OWL::DirectSemantics::Element::ObjectIntersectionOf::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::ObjectIntersectionOf::VERSION   = '0.000_03';
};
...
OWL::DirectSemantics::Element::ObjectIntersectionOf - represents an OWL ObjectIntersectionOf

=head1 DESCRIPTION

This class represents the ObjectIntersectionOf element in OWL Direct Semantics.
