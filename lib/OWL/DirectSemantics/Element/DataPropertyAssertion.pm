package OWL::DirectSemantics::Element::DataPropertyAssertion;

BEGIN {
	$OWL::DirectSemantics::Element::DataPropertyAssertion::AUTHORITY = 'cpan:TOBYINK';
	$OWL::DirectSemantics::Element::DataPropertyAssertion::VERSION   = '0.000_03';
};
...
OWL::DirectSemantics::Element::DataPropertyAssertion - represents an OWL DataPropertyAssertion

=head1 DESCRIPTION

This class represents the DataPropertyAssertion element in OWL Direct Semantics.
