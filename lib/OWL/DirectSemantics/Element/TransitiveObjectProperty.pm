package OWL::DirectSemantics::Element::TransitiveObjectProperty;
...
OWL::DirectSemantics::Element::TransitiveObjectProperty - represents an OWL TransitiveObjectProperty

=head1 DESCRIPTION

This class represents the TransitiveObjectProperty element in OWL Direct Semantics.
